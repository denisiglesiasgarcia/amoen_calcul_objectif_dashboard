...
if st.session_state["authentication_status"]:
    ...
    with tab3:
        ...
        # df_periode = make_dataframe_df_periode_list(st.session_state["data_site"])
        # df = make_dataframe_df_list(st.session_state["data_site"], df_meteo_tre200d0)
        ...
        ) = fonction_note_calcul(data_site, df_meteo_tre200d0)
        # Hide the index
        hide_index_style = """
            <style>
        ...
        formula_facteur_ponderation_moyen = (
            make_latex_formula_facteur_ponderation_moyen(st.session_state["data_site"])
        )
        ...
        df_meteo_note_calcul = make_dataframe_df_meteo_note_calcul(
            st.session_state["data_site"], df_meteo_tre200d0
        )
