...
def create_barplot_historique_amoen(data_df):
    ...
    fig = px.bar(df_barplot, x='periode', y='atteinte_objectif',
                 labels={'periode': 'Période', 'atteinte_objectif': "Atteinte de l'objectif [%]"},
    ...
    fig.update_layout(
        ...
        yaxis_range=[0, max(df_barplot['atteinte_objectif']) * 1.1],  # Extend y-axis range
