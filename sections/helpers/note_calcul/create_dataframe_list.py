...
def make_dataframe_df_list(data_site, DJ_REF_ANNUELS):
    ...
    df_list.append({
        ...
        "Valeur": data_site["repartition_energie_finale_partie_surelevee_chauffage"],
        "Unité": "%",
    ...
    df_list.append({
        ...
        "Unité": "%",
        "Commentaire": (
            "Part d'énergie finale (ECS) pour partie surélévée. "
            "0 si pas de surélévation"
        ),
        "Excel": "C89",
    ...
    df_list.append({
        ...
        "Unité": "%",
        "Commentaire": (
            "Part d'énergie finale (Chauffage + ECS) pour la partie rénové. "
            "100% si pas de surélévation"
        ),
        "Excel": "C91",
        "Variable/Formule": (
    ...
    df_list.append({
        ...
        "Commentaire": (
            ...
            "dj_periode (C101) / DJ_REF_ANNUELS (C102)"
        ),
        "Excel": "C93",
        "Variable/Formule": (
