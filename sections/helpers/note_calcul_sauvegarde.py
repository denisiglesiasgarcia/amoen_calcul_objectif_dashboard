...
def make_dataframe_df_list(data_site, df_meteo_tre200d0):
    ...
    data_site["agent_energetique_ef_mazout_somme_mj"] = (
        data_site["agent_energetique_ef_mazout_kg"] * CONVERSION_MAZOUT_MJ_KG
        + data_site["agent_energetique_ef_mazout_litres"] * CONVERSION_MAZOUT_MJ_LITRES
        + data_site["agent_energetique_ef_mazout_kwh"] * CONVERSION_MAZOUT_MJ_KWH
    )
    data_site["agent_energetique_ef_gaz_naturel_somme_mj"] = (
        data_site["agent_energetique_ef_gaz_naturel_m3"] * CONVERSION_GAZ_NATUREL_MJ_M3
    ...
    data_site["agent_energetique_ef_pellets_somme_mj"] = (
        data_site["agent_energetique_ef_pellets_m3"] * CONVERSION_PELLETS_MJ_M3
        + data_site["agent_energetique_ef_pellets_kg"] * CONVERSION_PELLETS_MJ_KG
        + data_site["agent_energetique_ef_pellets_kwh"] * CONVERSION_PELLETS_MJ_KWH
    )
    data_site["agent_energetique_ef_plaquettes_somme_mj"] = (
        data_site["agent_energetique_ef_plaquettes_m3"] * CONVERSION_PLAQUETTES_MJ_M3
        + data_site["agent_energetique_ef_plaquettes_kwh"]
        * CONVERSION_PLAQUETTES_MJ_KWH
    )
    data_site["agent_energetique_ef_cad_somme_mj"] = (
        data_site["agent_energetique_ef_cad_kwh"] * CONVERSION_CAD_MJ_KWH
    )
    ...
    data_site["agent_energetique_ef_autre_somme_mj"] = (
        data_site["agent_energetique_ef_autre_kwh"] * CONVERSION_AUTRE_MJ_KWH
    )
