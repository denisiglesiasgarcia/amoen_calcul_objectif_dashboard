...
def graphique_bars_rapport(site,
    ...
    u2_titre = plt.text(0.85, xlabel_level1, formula_atteinte_objectif_titre_pourcent, ha='left', va='center', transform=ax.transAxes, fontsize=18)
    ...
    u3 = plt.text(0.90, xlabel_level1, formula_atteinte_objectifs_pourcent, ha='left', va='center', transform=ax.transAxes, fontsize=20)
